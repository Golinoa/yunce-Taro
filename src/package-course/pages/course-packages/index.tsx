...
const CoursePackagesPage: React.FC = () => {
  ...
  }, [currentUserId, fetchPackageTemplatesByTeacher]);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (isEdit && editingId) {
        ...
        invalidatePackageTemplates(currentUserId);
  ...
  const handleDelete = useCallback(
    ...
    [loadTemplates, currentUserId, invalidatePackageTemplates],
  );
            ...
            <View className="flex gap-4">
              {PACKAGE_TYPES.map((t) => (
                ...
                >
                  ...
                  <Text className="text-[20rpx] text-muted-foreground block mt-1">{t.desc}</Text>
                </View>
              ))}
            </View>
          </View>
