 ...
 *
 * 首页按「功能介绍」「配置说明」两大分类聚合 FAQ，点击分类进入手风琴问答列表。
              ...
              {FAQ_CATEGORIES.map((category) => (
                ...
                >
                  <View className="w-[96rpx] h-[96rpx] rounded-[24rpx] bg-primary-10 center flex-shrink-0">
                    <Icon name={category.icon} size={48} color="primary" />
                  </View>
                  <View className="flex-1 min-w-0">
                    <Text className="text-[32rpx] font-bold text-foreground mb-[8rpx]">
                      {category.title}
                    </Text>
                    <Text className="text-[26rpx] text-muted-foreground leading-relaxed">
                      {category.subtitle}
