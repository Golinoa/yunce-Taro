...
const rawMockTeachers: Omit<TeacherUIModel, 'accessScope' | 'accessScopeText'>[] = [
  ...
  // ===== 中心校区 - 新增主讲（用于测试长列表与筛选） =====
  {
    ...
    status: 'active',
    campus: 'center',
    payHistory: genPayHistory(5, 8200, 700),
  },
  {
    id: 'teacher-021',
    name: '彭老师',
    ...
    color: AVATAR_COLORS[5],
    initial: '彭',
    deductions: [{ id: 'd7', reason: '公开课补贴', amount: 300, type: 'bonus' }],
    status: 'active',
    campus: 'center',
    payHistory: genPayHistory(4, 7800, 600),
  },
  {
    id: 'teacher-022',
    name: '于老师',
    ...
    status: 'active',
    campus: 'center',
    payHistory: genPayHistory(5, 6500, 500),
  },
  ...
  // ===== 南区分校 - 新增主讲/助教 =====
  {
    ...
    status: 'active',
    campus: 'south',
    payHistory: genPayHistory(4, 6400, 400),
  },
  {
    id: 'teacher-024',
    name: '袁老师',
    ...
    color: AVATAR_COLORS[0],
    initial: '袁',
    deductions: [{ id: 'd8', reason: '教具损耗', amount: 150, type: 'deduct' }],
    status: 'active',
    campus: 'south',
    payHistory: genPayHistory(3, 5600, 300),
  },
  {
    id: 'teacher-025',
    name: '蒋老师',
  ...
  },
  {
    ...
    status: 'active',
    campus: 'east',
    payHistory: genPayHistory(2, 1900, 150),
  },
  {
    id: 'teacher-028',
    name: '马老师',
    ...
    color: AVATAR_COLORS[6],
    initial: '马',
    deductions: [{ id: 'd9', reason: '试听成单奖励', amount: 200, type: 'bonus' }],
    status: 'active',
    campus: 'east',
    payHistory: genPayHistory(2, 1600, 200),
  },
  {
    id: 'teacher-029',
    name: '方老师',
    ...
    campus: 'east',
    resignType: 'quit',
    resignDate: '2025-03-20',
    resignReason: '回老家发展',
    payHistory: genPayHistory(3, 6000, 400, 1),
  },
  {
    id: 'teacher-030',
    name: '罗老师',
    ...
    status: 'active',
    campus: 'center',
    payHistory: genPayHistory(3, 2200, 200),
  },
];
