 ...
 * 通过 BottomSheet 展示，使用 Taro Picker mode="date" 选择起止日期
 */
    ...
    <BottomSheet visible={visible} title="自定义区间" onClose={onClose} maxHeight="60vh">
      <View className="px-[32rpx] py-[24rpx]">
        ...
        <View className="mb-[32rpx]">
          ...
          <Picker
            mode="date"
            value={start || todayStr}
            onChange={(e) => setStart(e.detail.value as string)}
          >
            <View className="bg-muted/30 rounded-[16rpx] px-[24rpx] py-[24rpx] flex items-center justify-between">
              <Text
        ...
        <View className="mb-[32rpx]">
          ...
          <Picker
            mode="date"
            value={end || todayStr}
            onChange={(e) => setEnd(e.detail.value as string)}
          >
            <View className="bg-muted/30 rounded-[16rpx] px-[24rpx] py-[24rpx] flex items-center justify-between">
